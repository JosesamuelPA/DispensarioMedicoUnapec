...
namespace DispensarioMedicoUnapec.Controllers
{
    public class MedicamentosController : Controller
    {
        ...
        {
            ViewData["Id_Tipo_Farmaco"] = new SelectList(_context.Tipo_Farmacos, "Id", "Estado");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Estado,Dosis,Id_Tipo_Farmaco")] Medicamento medicamento)
        {
            ...
            ViewData["Id_Tipo_Farmaco"] = new SelectList(_context.Tipo_Farmacos, "Id", "Estado", medicamento.Id_Tipo_Farmaco);
            return View(medicamento);
        }
